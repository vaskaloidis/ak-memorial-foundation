...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { email: @invite.email, golfer_number: @invite.golfer_number, sent_at: @invite.sent_at, user_id: @invite.user_id } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { email: @invite.email, golfer_number: @invite.golfer_number, sent_at: @invite.sent_at, user_id: @invite.user_id } }
